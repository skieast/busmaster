...
BEGIN_MESSAGE_MAP(CCAN_CANtact, CWinApp)
END_MESSAGE_MAP()

/**
 * CCAN_CANtact construction
 */
CCAN_CANtact::CCAN_CANtact()
{
...
BOOL CCAN_CANtact::InitInstance()
{
...
/* CDIL_CANtact class definition */
class CDIL_CAN_CANtact : public CBaseDIL_CAN_Controller
{
public:
...
USAGEMODE HRESULT GetIDIL_CAN_Controller(void** ppvInterface)
{
    ...
    hResult = S_OK;
    if (!g_pouDIL_CAN_CANtact)
    {
        g_pouDIL_CAN_CANtact = new CDIL_CAN_CANtact;
        if (!(g_pouDIL_CAN_CANtact))
        {
            hResult = S_FALSE;
        }
    }
    *ppvInterface = (void*)g_pouDIL_CAN_CANtact;  /* Doesn't matter even if g_pouDIL_CAN_CANtact is null */
 ...
 */
HRESULT CDIL_CAN_CANtact::CAN_SetAppParams(HWND hWndOwner)
{
 ...
 */
HRESULT CDIL_CAN_CANtact::CAN_UnloadDriverLibrary(void)
{
    return(S_OK);
}
 ...
 */
HRESULT CDIL_CAN_CANtact::CAN_ManageMsgBuf(BYTE bAction, DWORD ClientID, CBaseCANBufFSE* pBufObj)
{
 ...
 */
HRESULT CDIL_CAN_CANtact::CAN_RegisterClient(BOOL bRegister, DWORD& ClientID, char* pacClientName)
{
    HRESULT hResult = S_FALSE;
    INT Index;
 ...
 * status.
 */
HRESULT CDIL_CAN_CANtact::CAN_GetCntrlStatus(const HANDLE& hEvent, UINT& unCntrlStatus)
{
    (void)unCntrlStatus;
    (void)hEvent;
 ...
 */
HRESULT CDIL_CAN_CANtact::CAN_LoadDriverLibrary(void)
{
    return(S_OK);
}
...
*/
HRESULT CDIL_CAN_CANtact::CAN_PerformInitOperations(void)
{
    HRESULT hResult;
    DWORD dwClientID;
	...
	{
		sg_CANtactCanCfg->m_CanSnrStr[0] = '\0';
		sg_CANtactCanCfg->m_CanSpeed = 125;
...
*/
HRESULT CDIL_CAN_CANtact::CAN_PerformClosureOperations(void)
{
...
*/
HRESULT CDIL_CAN_CANtact::CAN_GetTimeModeMapping(SYSTEMTIME& CurrSysTime, UINT64& TimeStamp, LARGE_INTEGER& QueryTickCount)
{
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_ListHwInterfaces(INTERFACE_HW_LIST& asSelHwInterface, INT& nCount,PSCONTROLLER_DETAILS InitData)
{
    USES_CONVERSION;
	CWnd objMainWnd;
	int nRet;
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_SelectHwInterface(const INTERFACE_HW_LIST& /*asSelHwInterface*/, INT /*nCount*/)
{
    USES_CONVERSION;
...
*/
HRESULT CDIL_CAN_CANtact::CAN_DeselectHwInterface(void)
{
...
* \return        S_OK for success
*/
HRESULT CDIL_CAN_CANtact::CAN_SetConfigData(PSCONTROLLER_DETAILS ConfigFile, int Length)
{
    (void)Length;
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_StartHardware(void)
{
	USES_CONVERSION;
	HRESULT hResult;
    ...
    if(sg_CANtactCanCfg !=nullptr)
	{
		if (!str_has_char(sg_CANtactCanCfg->m_CanSnrStr))
    {
			sprintf(str, "Snr=%s", sg_CANtactCanCfg->m_CanSnrStr);
    }
    else
    {
        str[0]='\0';
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetCurrStatus(STATUSMSG& StatusData)
{
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetTxMsgBuffer(BYTE*& /*pouFlxTxMsgBuffer*/)
{
    return(S_OK);
}
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_SendMsg(DWORD dwClientID, const STCAN_MSG& sMessage)
{
    struct TCanMsg msg;
    static SACK_MAP sAckMap;
    HRESULT hResult;
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetBusConfigInfo(BYTE* /*BusInfo*/)
{
    return(S_OK);
}
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetLastErrorString(std::string& /* acErrorStr */)
{
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetControllerParams(LONG& lParam, UINT nChannel, ECONTR_PARAM eContrParam)
{
    HRESULT hResult;
...
HRESULT CDIL_CAN_CANtact::CAN_SetControllerParams(int /* nValue */, ECONTR_PARAM /* eContrparam */)
{
    return S_OK;
}
...
* \return        S_OK for success, S_FALSE for failure
*/
HRESULT CDIL_CAN_CANtact::CAN_GetErrorCount(SERROR_CNT& sErrorCnt, UINT nChannel, ECONTR_PARAM eContrParam)
{
    (void)eContrParam;
    (void)nChannel;
...
HRESULT CDIL_CAN_CANtact::CAN_SetHardwareChannel(PSCONTROLLER_DETAILS,DWORD /*dwDriverId*/,bool /*bIsHardwareListed*/, unsigned int /*unChannelCount*/)
{
    return S_OK;
}
static int str_has_char(char* s)
...
TCANtactCanCfg::TCANtactCanCfg(char CanSnrStr[],unsigned int CanSpeed, unsigned int CanBtrValue, BOOL bBitRateSelected)
{
...
int TCANtactCanCfg::InvokeAdavancedSettings(PSCONTROLLER_DETAILS pControllerDetails, UINT nCount,UINT )
{
	HRESULT result;
...
DOUBLE TCANtactCanCfg::vValidateBaudRate(DOUBLE dBaudRate,int,UINT )
{
